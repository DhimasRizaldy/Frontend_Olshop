...
const FormRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!passwordRegex.test(password)) {
      toast.error('Password must contain only alphanumeric characters');
      return;
    }
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {/* Button login google */}
      <Button classname="flex w-full items-center justify-center gap-3.5 font-medium rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-70 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-70">
        <span>
          <svg
            width="20"
            height="20"
